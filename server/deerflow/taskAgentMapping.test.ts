...
import { buildDeerFlowSubagentConfig } from "./taskAgentMapping.js";

test("builds DeerFlow subagent config from an AgentCard and settings", () => {
  ...
  const config = buildDeerFlowSubagentConfig(card, settings);
